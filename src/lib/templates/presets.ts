    ...
    participants: [
      {
        ...
        name: 'You',
        isSelf: true,
        avatarUrl: generateInitialsAvatar('You', true, 0),
      },
      {
        id: 'p2',
        name: 'Priya',
        isSelf: false,
        avatarUrl: generateInitialsAvatar('Priya', false, 1),
      },
    ],
    messages: [
  ...
  group: {
    ...
    participants: [
      ...
      },
      {
        ...
        name: 'Ananya',
        isSelf: false,
        avatarUrl: generateInitialsAvatar('Ananya', false, 1),
      },
      {
        id: 'g3',
        name: 'Dev',
        isSelf: false,
        avatarUrl: generateInitialsAvatar('Dev', false, 2),
      },
      {
        id: 'g4',
        name: 'Neha',
        isSelf: false,
        avatarUrl: generateInitialsAvatar('Neha', false, 3),
      },
    ],
    messages: [
